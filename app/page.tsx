...
export default function LandingPage() {
  ...
  if (initialLoading) return <div className="min-h-screen flex items-center justify-center font-bold text-indigo-600">Loading AL-EXAM Portal...</div>;
        ...
        {!session ? (
          ...
          <div className="mt-8 animate-in fade-in zoom-in duration-500">
            <button 
              ...
              disabled={loading}
              className="flex items-center gap-3 px-8 py-4 bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800 rounded-2xl hover:border-indigo-600 hover:shadow-xl hover:-translate-y-1 transition-all"
            >
              ...
              <span className="font-bold text-slate-700 dark:text-slate-200 text-lg">Continue with Google</span>
            </button>
          </div>
        ) : (
          /* 🛣️ Entry Routes */
          <div className="grid md:grid-cols-3 gap-6 w-full animate-in slide-in-from-bottom duration-700 mt-10">
